# -*- coding: utf-8 -*-
"""
    tests.persistence.DummyClientFixture
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
class DummyClientFixture:
    ...
    def test_crud_operations(self):
        ...
        # Get all dummies
        dummies = self._client.get_dummies(None, None, None)
        assert dummies != None
        assert 2 == len(dummies['data'])

        # Update the dummy
        dummy = self._client.update_dummy(
            None,
            dummy1['id'],
        ...
        # Delete the dummy
        self._client.delete_dummy(None, dummy1['id'])
