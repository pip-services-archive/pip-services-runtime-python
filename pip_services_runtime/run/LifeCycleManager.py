...
class LifeCycleManager(object):
    ...
    @staticmethod
    def link_components(context, components):
        LifeCycleManager.link(context, ComponentSet(components))

    @staticmethod
    def link(context, components):
    ...
    @staticmethod
    def link_and_open_components(context, components):
        LifeCycleManager.link_and_open(context, components)

    @staticmethod
    def link_and_open(context, components):
